...
export const ModalUpdateComic = ({
  visible,
  changeVisible,
  comicSlug,
}: ModalUpdateComicProps) => {
              ...
              {genres.map((genre) => (
                ...
                >
                  <Checkbox
                    ...
                    checked={removeAccentsAndLowerCaseArray(
                      comicGenres
                    ).includes(removeAccentsAndLowerCase(genre.name))}
                  />
